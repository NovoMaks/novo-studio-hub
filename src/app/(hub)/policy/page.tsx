  ...
  return (
    <div className='max-w-screen-md mx-auto overflow-hidden post'>
      ...
      <Typography>
        ...
        Самозанятой Зайцевой Алины Анатольевны ИНН 181001956299 (далее — Оператор).
      </Typography>
      ...
      <Typography variant='h2'>2. Основные понятия, используемые в Политике</Typography>
      ...
      <List sx={{ listStyle: 'decimal', pl: 8 }}>
        <ListItem sx={{ display: 'list-item' }}>
          <ListItemText>Фамилия, имя, отчество;</ListItemText>
        </ListItem>
        <ListItem sx={{ display: 'list-item' }}>
          <ListItemText>Электронный адрес;</ListItemText>
        </ListItem>
        <ListItem sx={{ display: 'list-item' }}>
          <ListItemText>Номера телефонов;</ListItemText>
        </ListItem>
        <ListItem sx={{ display: 'list-item' }}>
          <ListItemText>Данные аккаунтов мессенджеров;</ListItemText>
        </ListItem>
        <ListItem sx={{ display: 'list-item' }}>
          <ListItemText>Год, месяц, дата и место рождения;</ListItemText>
        </ListItem>
        <ListItem sx={{ display: 'list-item' }}>
        ...
        <ListItem sx={{ display: 'list-item' }}>
          <ListItemText>Сведения об организации, должность;</ListItemText>
        </ListItem>
        <ListItem sx={{ display: 'list-item' }}>
          <ListItemText>Сведения о местоположении; ip-адрес;</ListItemText>
        </ListItem>
        <ListItem sx={{ display: 'list-item' }}>
          <ListItemText>
            Тип и версия ОС; тип и версия Браузера; тип устройства и разрешение его экрана; язык ОС
            и Браузера;
          </ListItemText>
        </ListItem>
        <ListItem sx={{ display: 'list-item' }}>
      ...
      <Typography variant='h2'>4. Цели обработки персональных данных</Typography>
      ...
      <List sx={{ listStyle: 'decimal', pl: 8 }}>
        <ListItem sx={{ display: 'list-item' }}>
          <ListItemText>
            ...
            информации и/или материалам, содержащимся на веб-сайте; уточнение деталей заказа.
          </ListItemText>
        </ListItem>
        <ListItem sx={{ display: 'list-item' }}>
          <ListItemText>
            ...
            электронной почты A.M.Novo@ya.ru с пометкой «Отказ от уведомлениях о новых продуктах и
      ...
      <Typography variant='h2'>5. Правовые основания обработки персональных данных</Typography>
      ...
      <List sx={{ listStyle: 'decimal', pl: 8 }}>
        ...
        <ListItem sx={{ display: 'list-item' }}>
          <ListItemText>
            ...
            Оператора A.M.Novo@ya.ru с пометкой «Актуализация персональных данных».
          </ListItemText>
        </ListItem>
        <ListItem sx={{ display: 'list-item' }}>
          <ListItemText>
            ...
            уведомление посредством электронной почты на электронный адрес Оператора A.M.Novo@ya.ru
            с пометкой «Отзыв согласия на обработку персональных данных».
          </ListItemText>
        </ListItem>
      </List>

      <Typography variant='h2'>7. Трансграничная передача персональных данных</Typography>
      ...
      <Typography variant='h2'>8. Заключительные положения</Typography>
      ...
      <List sx={{ listStyle: 'decimal', pl: 8 }}>
        ...
        <ListItem sx={{ display: 'list-item' }}>
          <ListItemText>
            ...
            <a href='https://hub.novo-studio.ru/policy' target='_blank'>
              https://hub.novo-studio.ru/policy
            </a>
          </ListItemText>
        </ListItem>
      </List>
