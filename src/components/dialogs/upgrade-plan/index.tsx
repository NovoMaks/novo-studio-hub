      ...
      >
        ...
        <DialogContent className='overflow-visible pbs-0 sm:pli-16 sm:pbe-16'>
          <div className='flex items-end gap-4 flex-col sm:flex-row'>
            ...
            >
              <MenuItem value='Basic'>Базовый - 0/месяц</MenuItem>
              <MenuItem value='Standard'>Стандарт - 200/месяц</MenuItem>
              <MenuItem value='Enterprise'>Продвинутый - 400/месяц</MenuItem>
              <MenuItem value='StandardY'>Стандарт (Скидка 10%) - 2160/год</MenuItem>
              <MenuItem value='EnterpriseY'>Продвинутый (Скидка 10%) - 4320/год</MenuItem>
            </CustomTextField>
