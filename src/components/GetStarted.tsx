...
const GetStarted = () => {
  ...
  // Vars
  const getStartedImageLight = '/images/get-started/bg-light.png';
  const getStartedImageDark = '/images/get-started/bg-dark.png';

  // Hooks
  const getStartedImage = useImageVariant(
    settings.mode ?? 'system',
    getStartedImageLight,
    getStartedImageDark,
  );
